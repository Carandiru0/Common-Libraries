...
__m128i const __vectorcall Hash(__m128i const data, uint32_t const hashSeed) // upto 4x 32 bit numbers
{
	...
	__m128i h32(_mm_add_epi32(_mm_add_epi32(_mm_set1_epi32(oRandom.hashSeed), _mm_set1_epi32(hashSeed)), _mm_set1_epi32(PRIME32_5)));		// this where HashSetSeed has influence on random numbers generated going forward
