...
// color operations //
uvec4_v const  ImagingSRGBtoLinearVector(uint32_t const packed_srgb); // packed input 8bit SRGB, output 10bit LINEAR unpacked vector
uint32_t const ImagingSRGBtoLinear(uint32_t const packed_srgb);       // ""  "" "" ""  ""   ""   ""  ""   ""  ""  "" packed
