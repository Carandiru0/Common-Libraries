...
#undef b
	...
	namespace viridis_Konstants {
		XMGLOBALCONST inline XMVECTORF32 const _c0{ { { 0.2777273272234177f, 0.005407344544966578f, 0.3340998053353061f, 1.f } } };
		XMGLOBALCONST inline XMVECTORF32 const _c1{ { { 0.1050930431085774f, 1.404613529898575f, 1.384590162594685f, 1.f } } };
		XMGLOBALCONST inline XMVECTORF32 const _c2{ { { -0.3308618287255563f, 0.214847559468213f, 0.09509516302823659f, 1.f } } };
		XMGLOBALCONST inline XMVECTORF32 const _c3{ { { -4.634230498983486f, -5.799100973351585f, -19.33244095627987f, 1.f } } };
		XMGLOBALCONST inline XMVECTORF32 const _c4{ { { 6.228269936347081f, 14.17993336680509f, 56.69055260068105f, 1.f } } };
		XMGLOBALCONST inline XMVECTORF32 const _c5{ { { 4.776384997670288f, -13.74514537774601f, -65.35303263337234f, 1.f } } };
		XMGLOBALCONST inline XMVECTORF32 const _c6{ { { -5.435455855934631f, 4.645852612178535f, 26.3124352495832f, 1.f } } };
	} // end ns
	...
	namespace inferno_Konstants {
		XMGLOBALCONST inline XMVECTORF32 const _c0{ { { 0.0002189403691192265f, 0.001651004631001012f, -0.01948089843709184f, 1.f } } };
		XMGLOBALCONST inline XMVECTORF32 const _c1{ { { 0.1065134194856116f, 0.5639564367884091f, 3.932712388889277f, 1.f } } };
		XMGLOBALCONST inline XMVECTORF32 const _c2{ { { 11.60249308247187f, -3.972853965665698f, -15.9423941062914f, 1.f } } };
		XMGLOBALCONST inline XMVECTORF32 const _c3{ { { -41.70399613139459f, 17.43639888205313f, 44.35414519872813f, 1.f } } };
		XMGLOBALCONST inline XMVECTORF32 const _c4{ { { 77.162935699427f, -33.40235894210092f, -81.80730925738993f, 1.f } } };
		XMGLOBALCONST inline XMVECTORF32 const _c5{ { { -71.31942824499214f, 32.62606426397723f, 73.20951985803202f, 1.f } } };
		XMGLOBALCONST inline XMVECTORF32 const _c6{ { { 25.13112622477341f, -12.24266895238567f, -23.07032500287172f, 1.f } } };
	} // end ns
	...
	namespace skinny_Konstants {
		...
		XMGLOBALCONST inline XMVECTORF32 const _c0{ { { 0.0f, 58.0f/255.0f, 50.0f/255.0f, 1.f } } };
		XMGLOBALCONST inline XMVECTORF32 const _c1{ { { 30.0f/255.0f, 1.0f, 1.0f, 1.f } } };
	} // end ns
